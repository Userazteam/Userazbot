...
CmdHelp('spammer').add_command(
    'tspam', '<metin>', 'Verdiyiniz mətni tək tək ataraq spam göndərər.'
).add_command(
    'spam', '<miktar> <metin>', 'Verilen miqdarda spam göndərər.'
).add_command(
    'bigspam', '<miktar> <metin>', 'Verilen miqdarda spam göndərər.'
).add_command(
