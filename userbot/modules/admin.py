...
async def get_usersdel(show):
    ...
    try:
        ...
        await show.edit(
            "Lənət olsun, bu böyük bir qrup. Silinmiş istifadəçilər siyahısını bir fayl olaraq göndərirəm.")
...
async def get_bots(show):
    ...
    try:
        ...
        await show.edit(
            "Lanet olsun, burada çox bot var. Botların siyahısını bir fayl olaraq göndərirəm.")
...
CmdHelp('admin').add_command(
        ...
        'devet', '<istifadəço ad(lar)ı>', 'qrupa istədiyiniz hesabı əlavə edər.'
    ).add_command(
